  ...
  <div>
    ...
    >
      <template v-slot:left>
        ...
        <div class="onel">
          <p>
            <a style="color:white" href="http://curaprox.cf/blog/#/gum-care"
              >Learn More</a
            >
          </p>
          <p>
            <a style="color:white" href="http://curaprox.cf/#/shop">Buy</a>
          </p>
        </div>
      </template>
      <template v-slot:right>
        ...
        <div class="onel">
          <p>
            <a style="color:#0167b1" href="/#/InterdentalBrush">Learn More</a>
          </p>
          <p>
            <a
              style="color:#0167b1"
              href="http://curaprox.cf/#/shop/5fe1c094cb1555b636987209"
              >Buy</a
            >
          </p>
        </div>
