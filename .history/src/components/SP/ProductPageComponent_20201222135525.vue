        ...
        <div class="text">
          ...
          <div class="qty">
             <span class="input-group-btn">
              <button v-on:click="minusQty" type="button" class="btn btn-default btn-number" disabled="disabled" data-type="minus" data-field="quant[1]">
          ...
          <span class="input-group-btn">
              <button v-on:click="plusQty" type="button" class="btn btn-default btn-number" data-type="plus" data-field="quant[1]">
